...
import { CustomTransformerContext } from "../types";
 ...
 */
export function createHarmonyFactory(context: CustomTransformerContext): HarmonyFactory {
      ...
      switch (prop) {
        ...
        case "updateImportClause":
          return function (
            ...
            return tsThreeInstance.updateImportClause.apply(
              void 0,
              downSampleTsTypes(node, name, namedBindings)
            );
          };
        case "updateExportDeclaration":
          return function (
            ...
            const [dsNode, dsModuleSpecifier, dsExportClause] = downSampleTsTypes(
              node,
              moduleSpecifier,
              exportClause
            );
