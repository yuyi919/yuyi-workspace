...
export function generateSceneNumbers(
  currentSceneNumbers: string[],
  schema?: SceneNumberingSchema
): string[] {
  try {
 ...
 */
abstract class NumericSeriesSceneNumberingSchema implements SceneNumberingSchema {
  compare(a: string, b: string): number {
 ...
 */
export class StandardSceneNumberingSchema extends NumericSeriesSceneNumberingSchema {
