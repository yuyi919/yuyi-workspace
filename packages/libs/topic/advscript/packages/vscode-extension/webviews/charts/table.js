...
plugin.render = function (id, options) {
  ...
  $(SELECTOR_LENGTHMENU).html(
    '<div class="chartinfo">Show<a class="hyperbtn visiblecharsdd" href="#">&nbsp;<span>10</span><i class="codicon codicon-chevron-down" style="vertical-align: bottom;"></i></a>&nbsp;characters</div>'
  );
  $(SELECTOR_MORE).html(
    '<a class="smallbtn chartableoptsdd" style="text-align: center;float: right;height: 24px;line-height: 24px;" href="#"><i class="codicon codicon-ellipsis"></></a>'
  );
    ...
    build: function ($trigger, e) {
      ...
      for (let column of options.columns) {
        items[column.name] = {
          name: column.title,
          selected: function () {
            return datatable.column(column.name + ":name").visible();
          },
          updateOnClick: true,
          type: "check",
          ...
          callbackBefore: function () {
            datatable
              ...
              .visible(!datatable.column(column.name + ":name").visible());
          },
        };
      }
      return { items };
