 ...
 */
export const remove: RemoveFromTrie = (word) => (trie) => simpleRemove(word, trie);
 ...
 */
export const search: SearchPrefix = (word) => (trie) => simpleSearch(word, trie);
 ...
 */
export const hasPrefix: HasPrefix = (word) => (trie) => simpleHasPrefix(word, trie);
