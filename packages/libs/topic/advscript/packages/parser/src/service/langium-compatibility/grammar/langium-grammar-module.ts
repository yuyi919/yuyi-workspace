...
import {
  LangiumGrammarValidationRegistry,
  LangiumGrammarValidator,
} from "./langium-grammar-validator";
...
export const LangiumGrammarModule: Module<
  LangiumGrammarServices,
  PartialLangiumServices & LangiumGrammarAddedServices
> = {
  validation: {
...
export function createLangiumGrammarServices(
  context?: DefaultModuleContext
): LangiumGrammarServices {
  return inject(createDefaultModule(context), LangiumGrammarGeneratedModule, LangiumGrammarModule);
}
