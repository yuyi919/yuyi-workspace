 ...
 */
export function inject<I1, I2, I3, I extends I1 & I2 & I3>(
  module1: Module<I, I1>,
  module2?: Module<I, I2>,
  module3?: Module<I, I3>
): I {
...
function _inject<I, T>(module: Module<I, T>, injector?: any): T {
  const proxy: T = new Proxy({} as any, {
    ...
    getOwnPropertyDescriptor: (obj, prop) => (
      _resolve(obj, prop, module, injector || proxy), Object.getOwnPropertyDescriptor(obj, prop)
    ), // used by for..in
    has: (_, prop) => prop in module, // used by ..in..
    ownKeys: () => Reflect.ownKeys(module) as string[], // used by for..in
  });
  return proxy;
}
    ...
    if (obj[prop] === __requested__) {
      throw new Error(
        'Cycle detected. Please make "' +
          String(prop) +
          '" lazy. See https://langium.org/docs/di/cyclic-dependencies'
      );
    }
    return obj[prop];
