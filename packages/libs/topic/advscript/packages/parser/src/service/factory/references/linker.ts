...
export class DefaultLinker implements Linker {
  ...
  getCandidate(
    ...
    return (
      description ??
      this.createLinkingError({ container, property: getReferenceProperty(refId), reference })
    );
  }
        ...
        if (isAstNode(this._ref)) {
          ...
          this._ref =
            ...
            linker.createLinkingError(
              { container: node, property: getReferenceProperty(refId), reference },
              this._ref
            );
        }
      ...
      if (isLinkingError(description)) {
        ...
        return (
          ...
          this.createLinkingError(
            { container, property: getReferenceProperty(refId), reference },
            description
          )
        );
      }
