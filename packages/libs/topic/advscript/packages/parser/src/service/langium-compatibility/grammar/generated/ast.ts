...
export function isAbstractMetamodelDeclaration(
  item: unknown
): item is AbstractMetamodelDeclaration {
...
export type LangiumGrammarAstReference =
  | "Grammar:hiddenTokens"
  | "Grammar:usedGrammars"
  | "NamedArgument:parameter"
  | "CrossReference:type"
  | "RuleCall:rule"
  | "TerminalRuleCall:rule"
  | "ParserRule:hiddenTokens"
