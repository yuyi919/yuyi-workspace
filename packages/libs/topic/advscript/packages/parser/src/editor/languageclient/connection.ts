...
export function createConnection(
  ...
  return {
    ...
    ): Disposable => connection.onRequest(Is.string(type) ? type : type.method, handler),
    ...
    ): Disposable => connection.onNotification(Is.string(type) ? type : type.method, handler),
