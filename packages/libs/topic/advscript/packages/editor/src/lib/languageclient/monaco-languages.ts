...
export function testGlob(pattern: string, value: string): boolean {
  ...
  //     globstar: true
  // });
  return false; //regExp.test(value);
}
...
export class MonacoLanguages implements Languages {
  ...
  registerCompletionItemProvider(
    ...
    for (const language of this.matchLanguage(selector)) {
      providers.push(
        this._monaco.languages.registerCompletionItemProvider(language, completionProvider)
      );
    }
    return providers;
  }
  ...
  registerSignatureHelpProvider(
    ...
    for (const language of this.matchLanguage(selector)) {
      providers.push(
        this._monaco.languages.registerSignatureHelpProvider(language, signatureHelpProvider)
      );
    }
    return providers;
  }
  ...
  registerDefinitionProvider(selector: DocumentSelector, provider: DefinitionProvider): Disposable {
    ...
    for (const language of this.matchLanguage(selector)) {
      providers.push(
        this._monaco.languages.registerDefinitionProvider(language, definitionProvider)
      );
    }
    return providers;
  }
  ...
  registerDocumentSymbolProvider(
    ...
    for (const language of this.matchLanguage(selector)) {
      providers.push(
        this._monaco.languages.registerDocumentSymbolProvider(language, documentSymbolProvider)
      );
    }
    return providers;
  }
  ...
  registerCodeActionsProvider(
    ...
    for (const language of this.matchLanguage(selector)) {
      providers.push(
        this._monaco.languages.registerCodeActionProvider(language, codeActionProvider)
      );
    }
    return providers;
  }
  ...
  registerImplementationProvider(
    ...
    for (const language of this.matchLanguage(selector)) {
      providers.push(
        this._monaco.languages.registerImplementationProvider(language, implementationProvider)
      );
    }
    return providers;
  }
  ...
  registerTypeDefinitionProvider(
    ...
    for (const language of this.matchLanguage(selector)) {
      providers.push(
        this._monaco.languages.registerTypeDefinitionProvider(language, typeDefinitionProvider)
      );
    }
    return providers;
  }
  ...
  registerFoldingRangeProvider(
    ...
    for (const language of this.matchLanguage(selector)) {
      providers.push(
        this._monaco.languages.registerFoldingRangeProvider(language, foldingRangeProvider)
      );
    }
    return providers;
  }
