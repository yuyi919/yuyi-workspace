...
export function createVSCodeApi(servicesProvider: Services.Provider): typeof vscode {
  ...
  class CodeLens implements vscode.CodeLens {
    constructor(public range: vscode.Range, public command?: vscode.Command) {}
  ...
  class EmptyFileSystem implements vscode.FileSystem {
    ...
    delete(
      uri: vscode.Uri,
      options?: { recursive?: boolean | undefined; useTrash?: boolean | undefined } | undefined
    ): Thenable<void> {
      return Promise.resolve();
    }
    rename(
  ...
  const workspace: typeof vscode.workspace = {
    ...
    createFileSystemWatcher(
      ...
      if (services.workspace.createFileSystemWatcher) {
        const watcher = services.workspace.createFileSystemWatcher(
          globPattern,
          ignoreCreateEvents,
          ignoreChangeEvents,
          ignoreDeleteEvents
    ...
    getConfiguration(section, resource): vscode.WorkspaceConfiguration {
      ...
      const configuration = workspace.configurations
        ? workspace.configurations.getConfiguration(
            section,
            resource ? resource.toString() : undefined
          )
        : undefined;
    ...
    get onDidChangeTextDocument(): typeof vscode.workspace.onDidChangeTextDocument {
      ...
      return (
        ...
        return services.workspace.onDidChangeTextDocument(
  ...
  function isVsCodeUri(
    v: vscode.Uri | ReadonlyArray<[vscode.Uri, ReadonlyArray<vscode.Diagnostic> | undefined]>
  ): v is vscode.Uri {
  ...
  class ApiDiagnosticCollection implements vscode.DiagnosticCollection {
    ...
    set(
      arg0: vscode.Uri | ReadonlyArray<[vscode.Uri, ReadonlyArray<vscode.Diagnostic> | undefined]>,
      arg1?: ReadonlyArray<vscode.Diagnostic>
    ): void {
  ...
  const languages: typeof vscode.languages = {
    ...
    registerDocumentRangeFormattingEditProvider(selector, provider) {
      ...
      return languages.registerDocumentRangeFormattingEditProvider(selector, {
        provideDocumentRangeFormattingEdits({ textDocument, range, options }, token) {
          return provider.provideDocumentRangeFormattingEdits(
            <any>textDocument,
            <any>range,
            <any>options,
            token
      ...
      return languages.registerDocumentSemanticTokensProvider(
        selector,
        {
          ...
          provideDocumentSemanticTokensEdits:
            ...
            (({ textDocument, previousResultId }, token) => {
              return provider.provideDocumentSemanticTokensEdits!(
                <any>textDocument,
                <any>previousResultId,
                token
              ) as any;
            }),
        },
    ...
    registerDocumentRangeSemanticTokensProvider(
      ...
      return languages.registerDocumentRangeSemanticTokensProvider(
        selector,
        {
          provideDocumentRangeSemanticTokens({ textDocument, range }, token) {
            return provider.provideDocumentRangeSemanticTokens(
              <any>textDocument,
              <any>range,
              token
            ) as any;
  ...
  const window: typeof vscode.window = {
    ...
    createOutputChannel(name: string): vscode.OutputChannel {
      ...
      const channel: OutputChannel | undefined = createOutputChannel
        ? createOutputChannel.bind(window)(name)
        : undefined;
      return {
        name,
        ...
        show: (arg: any) => {
          if (arg !== undefined && typeof arg !== "boolean") {
            throw new Error(
              "unexpected preserveFocus argument: " + JSON.stringify(arg, undefined, 4)
            );
          }
