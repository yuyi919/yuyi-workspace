...
export type ExpParamArray = [base: number, extra: number, acc_a: number, acc_b: number];
...
export namespace ConsumableHitType {
...
export namespace ConsumableOccasion {
...
export namespace ConsumableScope {
  export type None = 0;
  export type Enemy = 1;
...
export namespace TroopEventPageSpan {
...
export namespace AutoRemovalTiming {
  export type Never = 0;
  export type Action = 1;
  export type Turn = 2;
}
export type AutoRemovalTiming =
  | AutoRemovalTiming.Never
  | AutoRemovalTiming.Action
  | AutoRemovalTiming.Turn;

export namespace StateMotion {
...
export type StateMotion =
  | StateMotion.Normal
  | StateMotion.Abnormal
  | StateMotion.Sleep
  | StateMotion.Dead;

export namespace StateOverlay {
  export type None = 0;
...
export namespace StateRestriction {
  export type None = 0;
...
export namespace AnimationDisplayType {
...
export namespace AttackMotionType {
  export type Thrust = 0;
  export type Swing = 1;
  export type Missile = 2;
}
export type AttackMotionType =
  | AttackMotionType.Thrust
  | AttackMotionType.Swing
  | AttackMotionType.Missile;
...
export namespace TitleCommandWindowBackground {
...
export namespace MapScrollType {
  export type Fixed = 0;
...
export namespace EventPriorityType {
  export type Under = 0;
  export type Normal = 1;
  export type Upper = 2;
}
...
export namespace EventMoveType {
  export type Stop = 0;
...
export namespace CommonEventTrigger {
  export type None = 0;
  export type Auto = 1;
