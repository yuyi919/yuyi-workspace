...
export class TouchInput {
  ...
  static _preventDefault = true;
  static setupEnable(enabled?: boolean) {
    this._preventDefault = enabled;
  }
  static addEventHandler(name: string, event: any, options?: boolean | AddEventListenerOptions) {
  ...
  static _setupEventHandlers(): void {
    ...
    this.addEventHandler("mousedown", this._onMouseDown.bind(this));
    this.addEventHandler("mousemove", this._onMouseMove.bind(this));
    this.addEventHandler("mouseup", this._onMouseUp.bind(this));
    this.addEventHandler("wheel", this._onWheel.bind(this), pf);
    this.addEventHandler("touchstart", this._onTouchStart.bind(this), pf);
    this.addEventHandler("touchmove", this._onTouchMove.bind(this), pf);
    this.addEventHandler("touchend", this._onTouchEnd.bind(this));
    this.addEventHandler("touchcancel", this._onTouchCancel.bind(this));
